		...
		for(int i=9;i<18;i++) {
			...
			switch (level) {
				...
				case 5:
					...
					glore.add(ChatColor.GREEN + " Every 100 unique blocks travelled, gain +1% speed.");
					glore.add(ChatColor.GREEN + "Resets on death.");
					ylore.add(ChatColor.DARK_GRAY + "Rewards Summary: ");
					ylore.add(ChatColor.YELLOW + " - Traveller");
					ylore.add(ChatColor.YELLOW + " Every 100 unique blocks travelled, gain +1% speed.");
					ylore.add(ChatColor.YELLOW + " Resets on death.");
					rlore.add(ChatColor.DARK_GRAY + "Rewards Summary: ");
					rlore.add(ChatColor.RED + " - Traveller");
					rlore.add(ChatColor.RED + " Every 100 unique blocks travelled, gain +1% speed.");
