package me.zach.DesertMC.GUImanager.ScoutManager;
	...
	public void openInventory() {
		...
		for(int i=9;i<18;i++) {
			...
			case 6:
				...
				glore.add(ChatColor.DARK_GRAY + " (+20% damage if the target is ");
				glore.add(ChatColor.DARK_GRAY + " facing away");
				
				ylore.add(ChatColor.DARK_GRAY + "Rewards Summary: ");
				ylore.add(ChatColor.YELLOW + "" + ChatColor.BOLD + " SHOP UNLOCK " + ChatColor.YELLOW + " - Scout Blade");
				ylore.add(ChatColor.DARK_GRAY + " (+20% damage if the target is ");
				ylore.add(ChatColor.DARK_GRAY + " facing away)");
				
				rlore.add(ChatColor.DARK_GRAY + "Rewards Summary: ");
				rlore.add(ChatColor.RED + "" + ChatColor.BOLD + " SHOP UNLOCK " + ChatColor.RED + " - Scout Blade");
				rlore.add(ChatColor.DARK_GRAY + " (+20% damage if the target is ");
				rlore.add(ChatColor.DARK_GRAY + " facing away)");
