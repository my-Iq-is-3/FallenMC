...
public class WrapperPlayServerEntityTeleport extends AbstractPacket {
    ...
    public static WrapperPlayServerEntityTeleport create(int entityId, double x, double y, double z, float yaw, float pitch){
    ...
    public static WrapperPlayServerEntityTeleport create(int entityId, Location location){
        return create(entityId, location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
    }
}
