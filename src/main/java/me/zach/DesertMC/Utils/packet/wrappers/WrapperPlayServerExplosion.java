...
public class WrapperPlayServerExplosion extends AbstractPacket {
    ...
    public static WrapperPlayServerExplosion create(List<BlockPosition> records, double x, double y, double z, float veloX, float veloY, float veloZ, float radius){
        WrapperPlayServerExplosion packet = new WrapperPlayServerExplosion();
        packet.setX(x);
        packet.setY(y);
        packet.setZ(z);
        packet.setPlayerVelocityX(veloX);
        packet.setPlayerVelocityY(veloY);
        packet.setPlayerVelocityZ(veloZ);
